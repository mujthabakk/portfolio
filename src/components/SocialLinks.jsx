...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mujthabakk/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@m_ujthaba__",
    icon: Instagram,
    url: "https://www.instagram.com/m_ujthaba__?utm_source=qr&igsh=anhzYnpzazUxeDFy",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@mujthabakk",
    icon: Github,
    url: "https://github.com/mujthabakk", // Fixed typo: "ttps" to "https"
    color: "#ffffff",
